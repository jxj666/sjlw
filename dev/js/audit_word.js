...
var main = {
    ...
    role_control: function() {
        if (common.role.val2) { //一审
            main.data.ajax1.stage = 0;
            return;
        } else if (common.role.val3) { //二审
            main.data.ajax1.stage = 1;
            $('.auid .s_exam2').addClass('active');
            return;
        } else if (common.role.val4) { //签发
            $('.audit2').hide();
            main.data.ajax1.stage = 2;
            $('.auid .s_exam3').addClass('active');
            return;
        }
    },
    //指派选择
